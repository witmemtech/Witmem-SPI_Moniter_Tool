...
public:
  ...
  void do_mousePressEvent(QMouseEvent *event);
  void do_mouseMoveEvent(QMouseEvent *event);
  void do_mouseReleaseEvent(QMouseEvent *event);
  void do_wheelEvent(QWheelEvent *event);

  void mouse_pos_limit(QPoint src_point, QPoint * ret_dst_point=nullptr);
